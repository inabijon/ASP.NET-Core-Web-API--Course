...
{
    /// <inheritdoc />
    public partial class SeedingDataforDiff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0118d470-04cb-4425-ace4-ebfd6daaccb0"), "Medium" },
                    { new Guid("3f80309a-a30a-4a1b-9ad6-4060933d2680"), "Hard" },
                    { new Guid("983fa0a0-5a8d-42c1-a13b-d7b9b5c3e6b0"), "Easy" },
                    { new Guid("ca91c06f-8927-4232-a7a2-0f3280373df2"), "Very Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0118d470-04cb-4425-ace4-ebfd6daaccb0"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("3f80309a-a30a-4a1b-9ad6-4060933d2680"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("983fa0a0-5a8d-42c1-a13b-d7b9b5c3e6b0"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ca91c06f-8927-4232-a7a2-0f3280373df2"));
